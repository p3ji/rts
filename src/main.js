...
function startOnline(opts) {
  const { net, seed, slot, mapSettings, playerCount, aiCount, teams } = opts
  const game = createGame({ humanCount: playerCount, aiCount: aiCount || 0, difficulty: 'normal', seed, mapSettings, teams })
